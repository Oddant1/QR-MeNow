...
__Actor:__ Sender <br>
__Description:__ A sender revokes a currently active QR code. <br>
...
__Actor:__ Sender <br>
__Description:__ A sender render an existing QR code temporarily invalid. <br>
__Preconditions:__ The sender has at least one existing active QR code registered. <br>
__Postconditions:__ The sender has a QR code is temporarily invalid. <br>
1. The sender accesses the system.
2. The sender selects an existing QR code.
3. The sender chooses to pause that QR code.
4. The sender chooses how long to pause the QR code for.
5. The sender confirms pausing the QR code.
6. The system invalidates the QR code for the configured amount of time.
